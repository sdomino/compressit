...
=== CLI
  ...
  Usage: compressit [option] [FILE_FROM] [FILE_TO]
    -h, --help                       Display this screen
    -v, --version                    Display current gem version
    -c, --css FILE_FROM FILE_TO      Compress css files from specified file to designated file
    -j, --js FILE_FROM FILE_TO       Compress javascript files from specified file to designated file
