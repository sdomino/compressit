...
Iterates through 'public/stylesheets' and compresses all .css files placing them into 'stylesheets/compressed/'
	
 rake compressit:css
	
Iterates through 'public/javascripts' and compresses all .js files placing them into 'javascripts/compressed/'
